...
apply(TPS_Homicide_20014_2018clean,function(x) length(unique(x)))
...
table(TPS_Homicide_20014_2018clean$occurence_year)
...
xtable_Homicide_Year
addmargins(xtable_Homicide_Year)
...
HomicideCountByYear <- table(TPS_Homicide_20014_2018clean$Homicide_Type + TPS_Homicide_20014_2018clean$Occurrence_year)
...
plot(rentals$Year, rentals$Bachelor, ylim=c(450,1700),xlab="Year", ylab="Price",type ="b",col="red")
